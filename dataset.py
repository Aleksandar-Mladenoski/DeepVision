# Original file provided by the profs for reading in the data
...
class ImagesDataset(Dataset):
    ...
    def __init__(
        ...
        self.targets = [self.classnames_to_ids[self.filenames_classnames[index][1]] for index in range(len(self.image_filepaths))]
        self.width = width
        self.height = height
        self.dtype = dtype
